...
class DB_Table_Manager {
    ...
    */
    ...
    function create(&$db, $table, $column_set, $index_set)
    {
        ...
        foreach ($index_set as $idxname => $val) {
            ...
            // patched to use longer index names only with PostgreSQL, to soothe MySQL, Oracle, etc.
            if ($db->phptype == "pgsql") {
    ...
    */
    ...
    function getDeclare($phptype, $coltype, $size = null, $scope = null,
        $require = null, $default = null, $unsigned = null)
    {
		...
		// set the "UNSIGNED" portion
        $declare .= ($unsigned) ? ' UNSIGNED' : '';
