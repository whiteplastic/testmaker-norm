...
define('MCAAITEM_DE', 'Mehrere Antwortalternativen zum Ordnen (randomisiert), ohne direkte Weiterleitung');
define('MCAAITEM_EN', 'Multiple answers for arranging (randomized), without quick forwarding');
 ...
 * @package Upload
 */
class McaaItem extends Item
{
	// Because capitalisation diffrenz between PHP4 and PHP5
	var $classname = 'McaaItem';
	public static $description = array(
					'de' => 'Mehrere Antwortalternativen sortierbar (randomisiert)',
					'en' => 'Multiple answers sortable (randomized)');
