...
class Editor
{
	 ...
	 * Create FCKeditor
	 *
	 * @param string WorkingPath for ImageBrowser
	 * @param mixed Content for Editor
	 */
	function Editor($workingUrl, $content = NULL)
	{
		...
		$this->editor->Config['ImageBrowserURL'] = '../../../../../index.php?page=browser&type=image&'.$workingUrl;
		$this->editor->Config['FlashBrowserURL'] = '../../../../../index.php?page=browser&type=flash&'.$workingUrl;
		$this->editor->ToolbarSet = 'testmaker';
		$this->editor->Width = '500px';
		$this->editor->Height = '300px';
		if ($content)
		{
